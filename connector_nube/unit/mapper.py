...
class TiendaNubeExportMapper(ExportMapper):

    def _map_direct(self, record, from_attr, to_attr):
        res = super(TiendaNubeExportMapper, self)._map_direct(record,
                                                              from_attr,
                                                              to_attr) or ''
...
class TranslationTiendaNubeExportMapper(TiendaNubeExportMapper):
