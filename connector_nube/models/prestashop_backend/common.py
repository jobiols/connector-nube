...
class TiendaNubeBackend(models.Model):
    ...
    _description = 'TiendaNube Backend Configuration'
    ...
    webservice_key = fields.Char(
            ...
            help="You have to put it in 'username' of the TiendaNube "
...
class TiendaNubeShopGroup(models.Model):
    _name = 'tienda_nube.shop.group'
    _inherit = 'tienda_nube.binding'
    _description = 'TiendaNube Shop Group'
...
class ShopGroupAdapter(GenericAdapter):
    ...
    _tienda_nube_model = 'shop_groups'
